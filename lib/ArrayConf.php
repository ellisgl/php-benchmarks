...
class ArrayConf
{
     ...
     */
    public function __construct($mainFile, $confLocation = 'conf')
    {
     ...
     */
    private function import($confFile)
    {
     ...
     * @return array|string
     */
    private function macroReplace($data)
    {
        if (is_array($data))
        {
            foreach ($data as $k => $v)
     ...
     * @return array
     */
    private function conformArray(array $arr)
    {
